...
//		totalPricePanel.setBackground(Color.RED);
	 ...
	 * 
	 * Cart mCart = new Cart(); JFrame frame = new JFrame(); frame.setBounds(0, 0,
	 * 1000, 750); frame.setLayout(null);
	 * 
	 * JPanel mPagePanel = new JPanel(); mPagePanel.setBounds(0, 150, 1000, 750);
	 * 
	 * frame.add(mPagePanel); mPagePanel.add("장바구니 상품 목록 보기", new
	 * CartItemListPage(mPagePanel, mCart)); frame.setVisible(true); }
	 */
